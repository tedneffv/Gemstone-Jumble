...
public class CityLevelTwelveCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 9: return GetBomb (position, bombNumber30);
		...
		case 17: return GetBomb (position, bombNumber30);
		...
		case 33: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 34: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 42: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 43: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 51: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 52: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 63: return GetBomb (position, bombNumber30);
		...
		case 71: return GetBomb (position, bombNumber30);
