...
public class CityLevelTwentyFiveCreator : MonoBehaviour {

	
	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber60;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 60: return GetBomb (position, bombNumber60);
		}
		return null;
	}
	...
	GameObject GetBomb (Vector3 position, GameObject bombNumber) {
		...
		switch (Random.Range (0, 4)) {
		case 0: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		...
		case 3: tempBomb = (GameObject)Instantiate (blueBomb, position, Quaternion.identity); break;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 1: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 6: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 8: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 9: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 10: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 11: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 15: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 16: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 17: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 18: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 19: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 20: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 24: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 25: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 26: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 27: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 28: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 29: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 30: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 31: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 32: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 33: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 34: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 35: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 36: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 37: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 38: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 39: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 40: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 41: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 42: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 43: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 44: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 45: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 46: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 47: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 48: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 49: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 50: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 51: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 52: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 53: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 54: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 55: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 56: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 57: return GetBomb (position, bombNumber60);
		case 58: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 59: return GetBomb (position, bombNumber60);
		case 60: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 61: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 62: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 63: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 64: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 65: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 66: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 67: return GetBomb (position, bombNumber60);
		case 68: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 69: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 70: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 71: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 72: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 73: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 75: return GetBomb (position, bombNumber60);
		case 76: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 77: return GetBomb (position, bombNumber60);
		case 78: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 79: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 80: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		}
		return null;
	}
