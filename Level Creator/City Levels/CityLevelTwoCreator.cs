...
public class CityLevelTwoCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber12;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 12: return GetBomb (position, bombNumber12);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 30: return GetBomb (position, bombNumber12);
		...
		case 40: return GetBomb (position, bombNumber12);
		...
		case 50: return GetBomb (position, bombNumber12);
