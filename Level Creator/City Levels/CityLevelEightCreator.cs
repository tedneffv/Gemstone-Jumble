...
public class CityLevelEightCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber5;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 5: return GetBomb (position, bombNumber5);
		}
		return null;
	}
	...
	GameObject GetBomb (Vector3 position, GameObject bombNumber) {
		...
		switch (Random.Range (0, 3)) {
		case 0: tempBomb = (GameObject)Instantiate (greenBomb, position, Quaternion.identity); break;
		...
		case 3: tempBomb = (GameObject)Instantiate (greenBomb, position, Quaternion.identity); break;
		case 4: tempBomb = (GameObject)Instantiate (purpleBomb, position, Quaternion.identity); break;
		case 5: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 8: return GetBomb (position, bombNumber5);
		...
		case 15: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 16: return GetBomb (position, bombNumber5);
		...
		case 24: return GetBomb (position, bombNumber5);
		case 25: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 32: return GetBomb (position, bombNumber5);
		...
		case 40: return GetBomb (position, bombNumber5);
		...
		case 48: return GetBomb (position, bombNumber5);
		...
		case 56: return GetBomb (position, bombNumber5);
		...
		case 64: return GetBomb (position, bombNumber5);
		...
		case 72: return GetBomb (position, bombNumber5);
