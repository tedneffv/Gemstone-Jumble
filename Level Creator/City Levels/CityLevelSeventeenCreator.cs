...
public class CityLevelSeventeenCreator : MonoBehaviour {

	
	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber15;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 15: return GetBomb (position, bombNumber15);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber15);
		...
		case 8: return GetBomb (position, bombNumber15);
		...
		case 30: return GetBomb (position, bombNumber15);
		case 31: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		case 32: return GetBomb (position, bombNumber15);
		...
		case 40: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		...
		case 48: return GetBomb (position, bombNumber15);
		case 49: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		case 50: return GetBomb (position, bombNumber15);
		...
		case 72: return GetBomb (position, bombNumber15);
		...
		case 80: return GetBomb (position, bombNumber15);
		}
		return null;
	}
