...
public class CityLevelElevenCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber20, bombNumber15;
	...
	GameObject GetBomb (Vector3 position, GameObject bombNumber) {
		...
		case 4: tempBomb = (GameObject)Instantiate (blueBomb, position, Quaternion.identity); break;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 36: return GetBomb (position, bombNumber15);
		...
		case 44: return GetBomb (position, bombNumber15);
		...
		case 76: return GetBomb (position, bombNumber15);
