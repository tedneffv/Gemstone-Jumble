...
public class CityLevelEighteenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 8: return GetBomb (position, bombNumber20);
		...
		case 24: return GetBomb (position, bombNumber20);
		...
		case 56: return GetBomb (position, bombNumber20);
		...
		case 60: return GetBomb (position, bombNumber20);
		...
		case 72: return GetBomb (position, bombNumber20);
