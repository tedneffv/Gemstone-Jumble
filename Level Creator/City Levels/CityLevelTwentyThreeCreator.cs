...
public class CityLevelTwentyThreeCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber10;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 10: return GetBomb (position, bombNumber10);
		}
		return null;
	}
	...
	GameObject GetBomb (Vector3 position, GameObject bombNumber) {
		...
		case 3: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber10);
		case 1: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 3: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 4: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 5: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 6: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 8: return GetBomb (position, bombNumber10);
			
		case 9: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 10: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 11: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 12: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 13: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 14: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 15: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 16: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 17: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 21: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 22: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 57: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 58: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 59: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 63: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 64: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 67: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 70: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 71: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
			
		case 72: return GetBomb (position, bombNumber10);
		case 73: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 75: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 76: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 77: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 78: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 79: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 80: return GetBomb (position, bombNumber10);
		}
		return null;
	}
