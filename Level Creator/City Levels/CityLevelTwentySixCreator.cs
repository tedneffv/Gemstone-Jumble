...
public class CityLevelTwentySixCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 1: return GetBomb (position, bombNumber30);
		case 2: return GetBomb (position, bombNumber30);
		...
		case 11: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 18: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 19: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 20: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 21: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 27: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 28: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 29: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 36: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 37: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 38: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 45: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 46: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 47: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 54: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 55: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 56: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 57: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 65: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 73: return GetBomb (position, bombNumber30);
		case 74: return GetBomb (position, bombNumber30);
