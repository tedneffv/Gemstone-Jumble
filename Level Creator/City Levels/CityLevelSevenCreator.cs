...
public class CityLevelSevenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 38: return GetBomb (position, bombNumber20);
		...
		case 42: return GetBomb (position, bombNumber20);
		...
		case 48: return GetBomb (position, bombNumber20);
		case 49: return GetBomb (position, bombNumber20);
		case 50: return GetBomb (position, bombNumber20);
