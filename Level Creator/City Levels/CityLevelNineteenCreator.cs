...
public class CityLevelNineteenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 1: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 3: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 4: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 5: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 6: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 8: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 26: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 35: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 44: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 53: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 58: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 62: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 65: return GetBomb (position, bombNumber30);
		case 66: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 67: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 72: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 73: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 75: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 76: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 80: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		}
		return null;
	}
