...
public class CityLevelFourteenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 31: return GetBomb (position, bombNumber30);
		...
		case 39: return GetBomb (position, bombNumber30);
		case 40: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 41: return GetBomb (position, bombNumber30);
		...
		case 49: return GetBomb (position, bombNumber30);
