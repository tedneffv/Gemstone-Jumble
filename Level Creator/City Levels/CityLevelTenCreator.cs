...
public class CityLevelTenCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber40, bombNumber50, bombNumber60, bombNumber70, bombNumber80;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		...
		case 50: return GetBomb (position, bombNumber50);
		case 60: return GetBomb (position, bombNumber60);
		case 70: return GetBomb (position, bombNumber70);
		case 80: return GetBomb (position, bombNumber80);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 48: return GetBomb (position, bombNumber50);
		...
		case 64: return GetBomb (position, bombNumber70);
		...
		case 72: return GetBomb (position, bombNumber80);
