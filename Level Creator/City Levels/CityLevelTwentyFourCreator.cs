...
public class CityLevelTwentyFourCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber30, bombNumber35;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		...
		case 35: return GetBomb (position, bombNumber35);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 31: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 39: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 40: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 41: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 49: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		...
		case 72: return GetBomb (position, bombNumber35);
