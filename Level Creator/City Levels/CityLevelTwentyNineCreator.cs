...
public class CityLevelTwentyNineCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber20, bombNumber25;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber20);
		case 1: return GetBomb (position, bombNumber20);
		case 2: return GetBomb (position, bombNumber20);
		...
		case 12: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 13: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 14: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 22: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 59: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 66: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 67: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 68: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 78: return GetBomb (position, bombNumber20);
		case 79: return GetBomb (position, bombNumber20);
		case 80: return GetBomb (position, bombNumber20);
		}
		return null;
	}
