...
public class CityLevelThirtyCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 90: return GetBomb (position, bombNumber90);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 61: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 67: return GetBomb (position, bombNumber90);
