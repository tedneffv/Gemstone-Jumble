...
public class CityLevelTwentyOneCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber20, bombNumber25, bombNumber30;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 58: return GetBomb (position, bombNumber20);
		...
		case 65: return GetBomb (position, bombNumber25);
		...
		case 69: return GetBomb (position, bombNumber25);
