...
public class CityLevelSixteenCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber5, bombNumber15;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBomb (position, bombNumber15);
		...
		case 49: return GetBomb (position, bombNumber5);
		case 50: return GetBomb (position, bombNumber5);
		...
		case 58: return GetBomb (position, bombNumber5);
