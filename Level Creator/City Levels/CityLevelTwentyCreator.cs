...
public class CityLevelTwentyCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber25;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 25: return GetBomb (position, bombNumber25);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 40: return GetBomb (position, bombNumber25);
		...
		case 77: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 78: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
