...
public class CityLevelTwentyTwoCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 66: return GetBomb (position, bombNumber30);
		case 67: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 68: return GetBomb (position, bombNumber30);
		...
		case 79: return GetBomb (position, bombNumber30);
