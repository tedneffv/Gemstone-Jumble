...
public class LevelThirtyCreator : MonoBehaviour {
	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber40, bombNumber42, bombNumber44, bombNumber46, bombNumber48, bombNumber50;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		...
		case 42: return GetBomb (position, bombNumber42);
		case 44: return GetBomb (position, bombNumber44);
		case 46: return GetBomb (position, bombNumber46);
		case 48: return GetBomb (position, bombNumber48);
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 29: return GetBomb (position, bombNumber40);
		...
		case 33: return GetBomb (position, bombNumber40);
		...
		case 38: return GetBomb (position, bombNumber42);
		...
		case 47: return GetBomb (position, bombNumber44);
		...
		case 51: return GetBomb (position, bombNumber44);
		...
		case 56: return GetBomb (position, bombNumber46);
		...
		case 60: return GetBomb (position, bombNumber46);
		...
		case 65: return GetBomb (position, bombNumber48);
		...
		case 69: return GetBomb (position, bombNumber48);
		...
		case 74: return GetBomb (position, bombNumber50);
		...
		case 78: return GetBomb (position, bombNumber50);
