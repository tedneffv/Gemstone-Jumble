...
public class LevelThreeCreator : MonoBehaviour {

	public GameObject redJewel, blueJewel, whiteJewel, greenJewel, orangeJewel, purpleJewel;
	public GameObject greenBomb, redBomb, blueBomb, orangeBomb, purpleBomb, whiteBomb;
	public GameObject bombNumber20;
	public GameObject boulder, steelBlock, pauseButton, powerButton, glassBorder, coin, topBanner, bottomBanner, pressedPowerButton;
	...
	GameObject tempJewel, instantiatedPowerButton, instantiatedPressedPowerButton;
...
//		Instantiate (coin, new Vector3 (.05f, 4.37f, -1), Quaternion.identity);
...
//					tempJewel = (GameObject)Instantiate(GetJewels (jewelCount), new Vector3 (startingLeftJewelPosition + (horizontalMultiplier * j), Random.Range (10, 15), -.5f), Quaternion.identity);
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		...
		switch (bombNumber) {
		case 20: return GetBombNumberTwenty (position);
		}
		return null;
	}
	...
	GameObject GetRandomJewel () {
		...
		case 1: return redJewel;
		case 2: return greenJewel;
		case 3: return orangeJewel;
		case 4: return purpleJewel;
	...
	GameObject GetBombNumberTwenty (Vector3 position) {
		GameObject tempBomb = null, tempNumber;
		switch (Random.Range (0, 6)) {
		case 0: tempBomb = (GameObject)Instantiate (blueBomb, position, Quaternion.identity); break;
		case 1: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		case 2: tempBomb = (GameObject)Instantiate (greenBomb, position, Quaternion.identity); break;
		case 3: tempBomb = (GameObject)Instantiate (whiteBomb, position, Quaternion.identity); break;
		case 4: tempBomb = (GameObject)Instantiate (orangeBomb, position, Quaternion.identity); break;
		case 5: tempBomb = (GameObject)Instantiate (purpleBomb, position, Quaternion.identity); break;
		}
		tempNumber = (GameObject)Instantiate (bombNumber20, new Vector3 (tempBomb.transform.position.x, tempBomb.transform.position.y, tempBomb.transform.position.z - .1f), Quaternion.identity);
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 1: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 2: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 3: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 4: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 5: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 6: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 7: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 8: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);

		case 9: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 10: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 11: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 12: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 13: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 14: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 15: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 16: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 17: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);

		case 18: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 19: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 20: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 21: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 22: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 23: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 24: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 25: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 26: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);

		case 27: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 28: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 29: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 30: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 31: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 32: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 33: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		...
		case 36: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 37: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 38: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 39: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 40: return GetBombNumberTwenty (position);
		case 41: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 42: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 43: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 44: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);

		case 45: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 46: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 47: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 48: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 49: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 50: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 51: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 52: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 53: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
			
		case 54: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 55: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 56: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 57: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 58: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 59: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 60: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 61: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 62: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);

		case 63: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 64: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
		case 65: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 66: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 67: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 68: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 69: return (GameObject) Instantiate (redJewel, position, Quaternion.identity);
		case 70: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity); 
		case 71: return (GameObject) Instantiate (purpleJewel, position, Quaternion.identity);
			
		case 72: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 73: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 74: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 75: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 76: return (GameObject) Instantiate (orangeJewel, position, Quaternion.identity);
		case 77: return (GameObject) Instantiate (blueJewel, position, Quaternion.identity);
		case 78: return (GameObject) Instantiate (whiteJewel, position, Quaternion.identity);
		case 79: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
		case 80: return (GameObject) Instantiate (greenJewel, position, Quaternion.identity);
