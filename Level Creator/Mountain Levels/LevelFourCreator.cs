...
public class LevelFourCreator : MonoBehaviour {
	...
	public GameObject boulder, steelBlock, steelBlockShiny, pauseButton, powerButton, glassBorder, coin, topBanner, bottomBanner, pressedPowerButton;
...
//		Instantiate (powerButton, new Vector3 (-2.3f, -4f, -90f), Quaternion.identity);
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 30: return (GameObject) Instantiate (steelBlockShiny, position, Quaternion.identity);
		case 31: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 32: return (GameObject) Instantiate (steelBlockShiny, position, Quaternion.identity);
		...
		case 48: return (GameObject) Instantiate (steelBlockShiny, position, Quaternion.identity);
		case 49: return (GameObject) Instantiate (boulder, position, Quaternion.identity);
		case 50: return (GameObject) Instantiate (steelBlockShiny, position, Quaternion.identity);
