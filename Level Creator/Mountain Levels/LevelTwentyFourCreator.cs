...
public class LevelTwentyFourCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 10: return GetBomb (position, bombNumber50);
		...
		case 16: return GetBomb (position, bombNumber50);
		...
		case 64: return GetBomb (position, bombNumber50);
		...
		case 70: return GetBomb (position, bombNumber50);
