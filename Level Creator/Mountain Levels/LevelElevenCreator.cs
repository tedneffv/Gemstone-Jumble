...
public class LevelElevenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return GetBombNumber40 (position);
		...
		case 8: return GetBombNumber40 (position);
		...
		case 72: return GetBombNumber40 (position);
		...
		case 80: return GetBombNumber40 (position);
		}
		return null;
	}
