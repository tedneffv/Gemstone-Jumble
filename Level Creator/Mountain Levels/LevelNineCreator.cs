...
public class LevelNineCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 20: return GetBombNumber20 (position);
		}
		return null;
	}
	...
	GameObject GetBombNumber20 (Vector3 position) {
