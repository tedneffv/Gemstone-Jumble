...
public class LevelFiveCreator : MonoBehaviour {

	public GameObject redJewel, blueJewel, whiteJewel, greenJewel, orangeJewel, purpleJewel;
	public GameObject greenBomb, redBomb, blueBomb, orangeBomb, purpleBomb, whiteBomb, bombNumber20;
	public GameObject boulder, steelBlock, steelBlockShiny, pauseButton, powerButton, glassBorder, coin, topBanner, bottomBanner;
...
//	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBombNumberTwenty (position);
		...
		case 76: return GetBombNumberTwenty (position);
