...
public class LevelTenCreator : MonoBehaviour {

	public GameObject redJewel, blueJewel, whiteJewel, greenJewel, orangeJewel, purpleJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber20, bombNumber50, bombNumber100;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 20: return GetBombNumber50 (position);
		}
		return null;
	}
	...
	GameObject GetBombNumber50 (Vector3 position) {
		GameObject tempBomb = null, tempNumber;
		switch (Random.Range (0, 6)) {
		case 0: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		case 1: tempBomb = (GameObject)Instantiate (whiteBomb, position, Quaternion.identity); break;
		...
		tempNumber = (GameObject)Instantiate (bombNumber50, new Vector3 (tempBomb.transform.position.x, tempBomb.transform.position.y, tempBomb.transform.position.z - .1f), Quaternion.identity);
		tempNumber.transform.parent = tempBomb.transform;
		return tempBomb;
	}

	GameObject GetBombNumber100 (Vector3 position) {
		GameObject tempBomb = null, tempNumber;
		switch (Random.Range (0, 6)) {
		case 0: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		case 1: tempBomb = (GameObject)Instantiate (whiteBomb, position, Quaternion.identity); break;
		...
		tempNumber = (GameObject)Instantiate (bombNumber100, new Vector3 (tempBomb.transform.position.x, tempBomb.transform.position.y, tempBomb.transform.position.z - .1f), Quaternion.identity);
		tempNumber.transform.parent = tempBomb.transform;
		return tempBomb;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBombNumber100 (position);
