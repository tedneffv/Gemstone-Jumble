...
public class LevelTwentyFiveCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber10, bombNumber12, bombNumber14, bombNumber16, bombNumber18;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		...
		case 14: return GetBomb (position, bombNumber14);
		case 16: return GetBomb (position, bombNumber16);
		case 18: return GetBomb (position, bombNumber18);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 40: return GetBomb (position, bombNumber10);
		...
		case 49: return GetBomb (position, bombNumber12);
		...
		case 58: return GetBomb (position, bombNumber14);
		...
		case 67: return GetBomb (position, bombNumber16);
		...
		case 76: return GetBomb (position, bombNumber18);
