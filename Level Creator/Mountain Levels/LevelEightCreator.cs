...
public class LevelEightCreator : MonoBehaviour {

	public GameObject redJewel, blueJewel, whiteJewel, greenJewel, orangeJewel, purpleJewel;
	public GameObject redBomb, blueBomb, whiteBomb, greenBomb, orangeBomb, purpleBomb, bombNumber30;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 78: return GetBomb (position, bombNumber30);
