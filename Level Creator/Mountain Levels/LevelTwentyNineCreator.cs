...
public class LevelTwentyNineCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 22: return GetBomb (position, bombNumber30);
		...
		case 38: return GetBomb (position, bombNumber30);
		...
		case 42: return GetBomb (position, bombNumber30);
		...
		case 58: return GetBomb (position, bombNumber30);
