...
public class LevelSeventeenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBomb (position, bombNumber20);
		...
		case 36: return GetBomb (position, bombNumber20);
		...
		case 44: return GetBomb (position, bombNumber20);
		...
		case 76: return GetBomb (position, bombNumber20);
