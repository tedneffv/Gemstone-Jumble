...
public class LevelFourteenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 60: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 76: return GetBomb (position, bombNumber50);
