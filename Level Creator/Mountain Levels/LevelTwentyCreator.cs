...
public class LevelTwentyCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber40);
		...
		case 20: return GetBomb (position, bombNumber40);
		...
		case 60: return GetBomb (position, bombNumber40);
		...
		case 80: return GetBomb (position, bombNumber40);
		}
		return null;
	}
