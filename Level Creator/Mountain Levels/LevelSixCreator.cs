...
public class LevelSixCreator : MonoBehaviour {

	public GameObject redJewel, blueJewel, whiteJewel, greenJewel, orangeJewel, purpleJewel;

	public GameObject greenBomb, redBomb, blueBomb, orangeBomb, purpleBomb, whiteBomb, bombNumber20, bombNumber25;
	public GameObject boulder, steelBlock, steelBlockShiny, pauseButton, powerButton, glassBorder, topBanner, bottomBanner;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		...
		case 21: return GetBombNumber25 (position);
		}
		return null;
	}
	...
	GameObject GetBombNumber25 (Vector3 position) {
		GameObject tempBomb = null, tempNumber;
		switch (Random.Range (0, 6)) {
		case 0: tempBomb = (GameObject)Instantiate (blueBomb, position, Quaternion.identity); break;
		case 1: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		...
		tempNumber = (GameObject)Instantiate (bombNumber25, new Vector3 (tempBomb.transform.position.x, tempBomb.transform.position.y, tempBomb.transform.position.z - .1f), Quaternion.identity);
		tempNumber.transform.parent = tempBomb.transform;
		return tempBomb;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 40: return GetBombNumber25 (position);
	...
	GameObject GetSteelBlock () {
		switch (Random.Range (0, 2)) {
		case 0: return steelBlock;
		case 1: return steelBlockShiny;
		}
		return null;
	}
