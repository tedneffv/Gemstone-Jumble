...
public class LevelTwentySevenCreator: MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber35);
		...
		case 8: return GetBomb (position, bombNumber35);
		...
		case 18: return GetBomb (position, bombNumber35);
		...
		case 26: return GetBomb (position, bombNumber35);
		...
		case 36: return GetBomb (position, bombNumber35);
		...
		case 44: return GetBomb (position, bombNumber35);
		...
		case 54: return GetBomb (position, bombNumber35);
		...
		case 62: return GetBomb (position, bombNumber35);
		...
		case 80: return GetBomb (position, bombNumber35);
		}
		return null;
	}
