...
public class LevelTwentySixCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 15: return GetBomb (position, bombNumber10);
		...
		case 48: return GetBomb (position, bombNumber10);
		case 49: return GetBomb (position, bombNumber10);
		case 50: return GetBomb (position, bombNumber10);
		...
		case 57: return GetBomb (position, bombNumber10);
		case 58: return GetBomb (position, bombNumber10);
		case 59: return GetBomb (position, bombNumber10);
		...
		case 66: return GetBomb (position, bombNumber10);
		case 67: return GetBomb (position, bombNumber10);
		case 68: return GetBomb (position, bombNumber10);
