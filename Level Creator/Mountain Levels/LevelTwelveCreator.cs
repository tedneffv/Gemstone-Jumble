...
public class LevelTwelveCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 40: return GetBombNumber40 (position);
		}
		return null;
	}
	...
	GameObject GetBombNumber40 (Vector3 position) {
		GameObject tempBomb = null, tempNumber;
		switch (Random.Range (0, 6)) {
		case 0: tempBomb = (GameObject)Instantiate (redBomb, position, Quaternion.identity); break;
		case 1: tempBomb = (GameObject)Instantiate (whiteBomb, position, Quaternion.identity); break;
		case 2: tempBomb = (GameObject)Instantiate (purpleBomb, position, Quaternion.identity); break;
		case 3: tempBomb = (GameObject)Instantiate (blueBomb, position, Quaternion.identity); break;
		case 4: tempBomb = (GameObject)Instantiate (greenBomb, position, Quaternion.identity); break;
		case 5: tempBomb = (GameObject)Instantiate (orangeBomb, position, Quaternion.identity); break;
		}
		tempNumber = (GameObject)Instantiate (bombNumber40, new Vector3 (tempBomb.transform.position.x, tempBomb.transform.position.y, tempBomb.transform.position.z - .1f), Quaternion.identity);
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 69: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		...
		case 76: return GetBombNumber40 (position);
