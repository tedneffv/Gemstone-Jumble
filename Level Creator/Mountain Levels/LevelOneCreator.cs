...
public class LevelOneCreator : MonoBehaviour {
	...
	public GameObject boulder, steelBlock, pauseButton, topBanner, bottomBanner, powerButton, glassBorder, pressedPowerButton;
	...
	GameObject tempJewel, instantiatedPowerButton;
	...
	void Start () {
		...
		GameObject instantiatedPressedPowerButton = (GameObject)Instantiate (pressedPowerButton, new Vector3 (instantiatedPowerButton.transform.position.x, instantiatedPowerButton.transform.position.y, instantiatedPowerButton.transform.position.z - .1f), Quaternion.identity);
	...
	public void InstantiateJewels () {
		for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 9; j++) {
				...
				//				jewelCount++;
				if ((i == 2 && j == 3) || (i == 3 && j == 3) || (i == 4 && j == 3) || (i == 4 && j == 4)) {
					GameObject temp = instantiator.GetJewelGridGameObject (i, j);
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 30: return GetBomb (position, bombNumber30, GetBombString ());
		}
		return null;
	}

	string GetBombString () {
	...
	GameObject GetBomb (Vector3 position, GameObject bombNumber, string bombColor) {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 1: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 3: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 4: return GetBomb (position, bombNumber30, "purple");
		case 5: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 6: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 8: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
			
		case 9: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 10: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 11: return GetBomb (position, bombNumber30, "green");
		case 12: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 13: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 14: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 15: return GetBomb (position, bombNumber30, "white");
		case 16: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 17: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
			
		case 18: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 19: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		...
		case 22: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 24: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 25: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 26: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
			
		case 27: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		...
		case 30: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 31: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 32: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 33: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 34: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 35: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
			
		case 36: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 37: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 38: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 39: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 40: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 41: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 42: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		...
		case 46: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 47: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 48: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 49: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 50: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 51: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 52: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 53: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
			
		case 54: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 55: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 56: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		...
		case 60: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		...
		case 64: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 65: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		...
		case 68: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 69: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 70: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 71: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
			
		case 72: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 73: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 75: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		...
		case 79: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 80: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		}
		return null;
	}
	...
	public void AddOneToDeleteNumber () {
		deleteNumber++;
	}
