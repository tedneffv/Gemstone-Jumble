...
public class LevelSevenCreator : MonoBehaviour {
	public GameObject redJewel, blueJewel, whiteJewel, greenJewel, orangeJewel, purpleJewel;
	public GameObject redBomb, blueBomb, whiteBomb, greenBomb, orangeBomb, purpleBomb, bombNumber20;
	public GameObject boulder, steelBlock, steelBlockShiny, pauseButton, powerButton, coin, glassBorder, topBanner, bottomBanner;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBombNumber20 (position);
		...
		case 36: return GetBombNumber20 (position);
		...
		case 44: return GetBombNumber20 (position);
		...
		case 76: return GetBombNumber20 (position);
