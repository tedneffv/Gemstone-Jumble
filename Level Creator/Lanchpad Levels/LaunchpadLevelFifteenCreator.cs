...
public class LaunchpadLevelFifteenCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber80;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber80);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBlockBomb (position, bombNumber80, boulderStage2);
		...
		case 36: return GetBlockBomb (position, bombNumber80, boulderStage2);
		...
		case 44: return GetBlockBomb (position, bombNumber80, boulderStage2);
		...
		case 76: return GetBlockBomb (position, bombNumber80, boulderStage2);
