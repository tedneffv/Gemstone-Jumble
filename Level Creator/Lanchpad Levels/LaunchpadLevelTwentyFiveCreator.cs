...
public class LaunchpadLevelTwentyFiveCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber50;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber50);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber50, slugStage2);
		...
		case 16: return GetBlockBomb (position, bombNumber50, boulderStage4);
		...
		case 36: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 70: return GetBlockBomb (position, bombNumber50, boulderStage4);
		case 71: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity); 
			
		case 72: temp = GetSlugBomb (position, bombNumber50, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
