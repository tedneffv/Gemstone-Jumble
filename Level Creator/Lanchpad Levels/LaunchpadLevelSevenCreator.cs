...
public class LaunchpadLevelSevenCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 72: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			...
			return temp;
		case 73: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 74: temp = GetSlugBomb (position, bombNumber30, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 75: temp = GetSlugBomb (position, bombNumber30, slugStage3);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 76: temp = GetSlugBomb (position, bombNumber30, slugStage4);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 77: temp = GetSlugBomb (position, bombNumber30, slugStage3);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 78: temp = GetSlugBomb (position, bombNumber30, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 79: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
