...
public class LaunchpadLevelTwentyFourCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 1: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 2: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 3: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 4: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 5: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 6: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 7: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 36: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
