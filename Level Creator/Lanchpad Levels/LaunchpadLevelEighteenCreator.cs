...
public class LaunchpadLevelEighteenCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber65);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 3: return GetBlockBomb (position, bombNumber65, boulder);
		case 4: return GetBlockBomb (position, bombNumber65, boulder);
		case 5: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 13: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 40: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 67: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 75: return GetBlockBomb (position, bombNumber65, boulder);
		case 76: return GetBlockBomb (position, bombNumber65, boulder);
		case 77: return GetBlockBomb (position, bombNumber65, boulder);
