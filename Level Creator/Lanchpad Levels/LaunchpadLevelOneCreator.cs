...
public class LaunchpadLevelOneCreator : MonoBehaviour {
	...
	public GameObject boulder, boulderStage2, boulderStage3, steelBlock, pauseButton, topBanner, bottomBanner, powerButton, glassBorder, slugStage1, slugStage2, slugStage3, slugStage4;
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 38: temp = GetSlugBomb (position, bombNumber70, slugStage4);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 39: temp = GetSlugBomb (position, bombNumber70, slugStage4);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 40: temp = GetSlugBomb (position, bombNumber70, slugStage4);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 41: temp = GetSlugBomb (position, bombNumber70, slugStage4);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 42: temp = GetSlugBomb (position, bombNumber70, slugStage4);
			SlugListManager.AddToSlugList (temp);
			return temp;
