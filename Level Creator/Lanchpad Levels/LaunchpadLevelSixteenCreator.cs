...
public class LaunchpadLevelSixteenCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber25, bombNumber45, bombNumber87;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber87);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 1: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 2: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 3: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 4: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 5: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 6: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 7: return GetBlockBomb (position, bombNumber87, boulderStage3);
		case 8: return GetBlockBomb (position, bombNumber87, boulderStage3);
		...
		case 18: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 19: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 20: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 21: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 22: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 23: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 24: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 25: return GetBlockBomb (position, bombNumber45, boulderStage2);
		case 26: return GetBlockBomb (position, bombNumber45, boulderStage2);
		...
		case 36: return GetBlockBomb (position, bombNumber25, boulder);
		case 37: return GetBlockBomb (position, bombNumber25, boulder);
		case 38: return GetBlockBomb (position, bombNumber25, boulder);
		case 39: return GetBlockBomb (position, bombNumber25, boulder);
		case 40: return GetBlockBomb (position, bombNumber25, boulder);
		case 41: return GetBlockBomb (position, bombNumber25, boulder);
		case 42: return GetBlockBomb (position, bombNumber25, boulder);
		case 43: return GetBlockBomb (position, bombNumber25, boulder);
		case 44: return GetBlockBomb (position, bombNumber25, boulder);
