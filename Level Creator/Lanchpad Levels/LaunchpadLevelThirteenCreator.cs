...
public class LaunchpadLevelThirteenCreator : MonoBehaviour {
	...
	GameObject jewelCollectorOne, jewelCollectorTwo, jewelCollectorThree, jewelCollectorFour, jewelCollectorFive, jewelCollectorSix;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 1: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 2: return GetBlockBomb (position, bombNumber90, boulderStage4);
		case 3: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 4: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 5: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 6: return GetBlockBomb (position, bombNumber90, boulderStage4);
		case 7: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 8: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
			
		case 9: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 10: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 11: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 12: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 13: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 14: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 15: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 16: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 17: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
			
		case 18: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 19: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 20: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 24: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 25: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 26: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
			
		case 27: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 28: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 34: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 35: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
			
		case 36: return GetBlockBomb (position, bombNumber90, boulderStage4);
		case 37: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 38: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 42: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 43: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 44: return GetBlockBomb (position, bombNumber90, boulderStage4);
			
		case 45: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity); 
		case 46: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 52: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 53: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
			
		case 54: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 55: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 56: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 60: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 61: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 62: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
			
		case 63: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 64: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 65: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 66: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 67: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 68: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 69: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 70: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 71: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity); 
			
		case 72: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 73: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 74: return GetBlockBomb (position, bombNumber90, boulderStage4);
		case 75: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 76: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 77: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 78: return GetBlockBomb (position, bombNumber90, boulderStage4);
		case 79: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 80: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		}
		return null;
	}
