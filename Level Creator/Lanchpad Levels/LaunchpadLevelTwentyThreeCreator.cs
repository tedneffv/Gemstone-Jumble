...
public class LaunchpadLevelTwentyThreeCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 18: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
		...
		case 22: return GetBlockBomb (position, bombNumber65, boulderStage4);
		...
		case 26: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 36: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 40: return GetBlockBomb (position, bombNumber65, boulderStage4);
		...
		case 44: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 54: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 58: return GetBlockBomb (position, bombNumber65, boulderStage4);
		...
		case 62: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
