...
public class LaunchpadLevelNineteenCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
		...
		case 36: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 76: temp = (GameObject)Instantiate (slugStage4, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
