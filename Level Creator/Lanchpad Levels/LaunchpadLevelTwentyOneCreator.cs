...
public class LaunchpadLevelTwentyOneCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber70;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber70);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBlockBomb (position, bombNumber70, boulder);
		...
		case 4: return GetBlockBomb (position, bombNumber70, boulder);
		...
		case 8: return GetBlockBomb (position, bombNumber70, boulder);
			
		case 9: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 13: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 17: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 30: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 31: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 32: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 36: return GetBlockBomb (position, bombNumber70, boulder);
		...
		case 39: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 40: return GetBlockBomb (position, bombNumber70, boulder);
		case 41: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 44: return GetBlockBomb (position, bombNumber70, boulder);
		...
		case 48: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 49: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 50: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 63: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 67: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 71: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity); 
			
		case 72: return GetBlockBomb (position, bombNumber70, boulder);
		...
		case 76: return GetBlockBomb (position, bombNumber70, boulder);
		...
		case 80: return GetBlockBomb (position, bombNumber70, boulder);
		}
		return null;
	}
