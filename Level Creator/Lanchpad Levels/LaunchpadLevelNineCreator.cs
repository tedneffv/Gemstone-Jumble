...
public class LaunchpadLevelNineCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBlockBomb (position, bombNumber70, boulderStage4);
		...
		case 8: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		...
		case 21: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 29: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 72: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
