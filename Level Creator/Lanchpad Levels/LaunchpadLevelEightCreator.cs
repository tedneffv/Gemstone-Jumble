...
using System.Collections;
		...
		public class LaunchpadLevelEightCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber40;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber40);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 19: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 20: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 21: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 22: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 24: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 25: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 38: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 39: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 40: return GetBlockBomb (position, bombNumber40, boulder);
		case 41: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 42: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 55: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 56: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 57: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 58: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 59: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 60: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 61: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
