...
public class LaunchpadLevelFourCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 7: return GetBlockBomb (position, bombNumber60, boulderStage4);
		case 8: return GetBlockBomb (position, bombNumber60, boulderStage4);
		...
		case 17: return GetBlockBomb (position, bombNumber60, boulderStage4);
