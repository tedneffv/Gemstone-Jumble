...
public class LaunchpadLevelTwentyCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 1: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 2: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 3: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 4: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 5: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 6: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 7: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 8: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 72: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 73: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 74: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 75: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 76: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 77: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 78: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 79: temp = GetSlugBomb (position, bombNumber70, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 80: temp = GetSlugBomb (position, bombNumber70, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		}
		return null;
