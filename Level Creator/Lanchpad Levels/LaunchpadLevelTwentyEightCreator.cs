...
public class LaunchpadLevelTwentyEightCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber35;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber35);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber35, slugStage3);
		...
		case 20: temp = GetSlugBomb (position, bombNumber35, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 40: return GetBlockBomb (position, bombNumber35, boulder);
