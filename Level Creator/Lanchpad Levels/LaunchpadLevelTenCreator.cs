...
public class LaunchpadLevelTenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 16: return GetBlockBomb (position, bombNumber95, boulder);
		...
		case 40: return GetBlockBomb (position, bombNumber95, boulderStage4);
		...
		case 64: return GetBlockBomb (position, bombNumber95, boulderStage2);
		...
		case 70: return GetBlockBomb (position, bombNumber95, boulderStage3);
