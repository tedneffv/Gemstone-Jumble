...
public class LaunchpadLevelTwelveCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
		...
		case 4: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 8: temp =  (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 36: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 40: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 72: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 80: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		}
		return null;
