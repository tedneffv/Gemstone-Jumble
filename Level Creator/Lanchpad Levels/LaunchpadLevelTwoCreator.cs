...
public class LaunchpadLevelTwoCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber30);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 22: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 33: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 36: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 40: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 47: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 51: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 57: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 58: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 59: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		...
		case 72: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 73: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 75: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 76: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 77: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 78: return (GameObject)Instantiate (boulderStage4, position, Quaternion.identity);
		case 79: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 80: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		}
		return null;
