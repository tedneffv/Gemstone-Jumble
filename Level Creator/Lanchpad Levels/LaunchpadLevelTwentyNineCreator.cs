...
public class LaunchpadLevelTwentyNineCreator : MonoBehaviour {
	...
	void Start () {
		...
		GameObject.Find ("Jewel Collector").GetComponent<MoveNumberHandler> ().SetMoveNumbers (40);
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		...
		case 80: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		}
		return null;
	}
