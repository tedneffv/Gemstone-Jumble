...
public class LaunchpadLevelElevenCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber25);
		}
		return null;
	}
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 4: return GetBlockBomb (position, bombNumber25, boulder);
		...
		case 10: return GetBlockBomb (position, bombNumber25, boulder);
		...
		case 16: return GetBlockBomb (position, bombNumber25, boulder);
		...
		case 21: return GetBlockBomb (position, bombNumber25, boulderStage2);
		case 22: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 23: return GetBlockBomb (position, bombNumber25, boulderStage2);
		...
		case 29: return GetBlockBomb (position, bombNumber25, boulderStage2);
		case 30: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 31: return GetBlockBomb (position, bombNumber25, boulderStage3);
		case 32: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 33: return GetBlockBomb (position, bombNumber25, boulderStage2);
		...
		case 39: return GetBlockBomb (position, bombNumber25, boulderStage3);
		case 40: return GetBlockBomb (position, bombNumber25, boulderStage4);
		case 41: return GetBlockBomb (position, bombNumber25, boulderStage3);
		...
		case 47: return GetBlockBomb (position, bombNumber25, boulderStage2);
		case 48: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 49: return GetBlockBomb (position, bombNumber25, boulderStage3);
		case 50: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 51: return GetBlockBomb (position, bombNumber25, boulderStage2);
		...
		case 57: return GetBlockBomb (position, bombNumber25, boulderStage2);
		case 58: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 59: return GetBlockBomb (position, bombNumber25, boulderStage2);
		...
		case 64: return GetBlockBomb (position, bombNumber25, boulder);
		...
		case 70: return GetBlockBomb (position, bombNumber25, boulder);
		...
		case 76: return GetBlockBomb (position, bombNumber25, boulder);
