...
public class CabinLevelEightCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber45;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 50: return GetBomb (position, bombNumber45);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber45);
		...
		case 4: return GetBomb (position, bombNumber45);
		...
		case 8: return GetBomb (position, bombNumber45);
		...
		case 36: return GetBomb (position, bombNumber45);
		...
		case 40: return GetBomb (position, bombNumber45);
		...
		case 44: return GetBomb (position, bombNumber45);
		...
		case 72: return GetBomb (position, bombNumber45);
		...
		case 76: return GetBomb (position, bombNumber45);
		...
		case 80: return GetBomb (position, bombNumber45);
		}
		return null;
	}
