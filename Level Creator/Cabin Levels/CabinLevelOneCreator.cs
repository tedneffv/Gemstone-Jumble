...
public class CabinLevelOneCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 36: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 44: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
