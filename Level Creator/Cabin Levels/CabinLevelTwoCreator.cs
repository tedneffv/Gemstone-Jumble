...
public class CabinLevelTwoCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber20;
	public GameObject boulder, boulderStage2, boulderStage3, steelBlock, pauseButton, topBanner, bottomBanner, powerButton, glassBorder, slugStage3;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 1: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 3: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 4: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 5: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 6: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 8: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		...
		case 11: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 12: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 13: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 14: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 15: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 16: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 17: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		...
		case 20: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 21: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 22: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 24: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 25: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 26: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
			
		case 27: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 28: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 29: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 30: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 31: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 32: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 33: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 34: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 35: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
			
		case 36: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 37: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 38: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 39: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 40: return GetBomb (position, bombNumber20);
		case 41: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 42: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 43: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		...
		case 46: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 47: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 48: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 49: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 50: return (GameObject)Instantiate (steelBlock, position, Quaternion.identity);
		case 51: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 52: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 53: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
			
		case 54: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 55: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		...
		case 58: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		case 59: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 60: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 61: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 62: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
			
		case 63: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 64: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 65: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 66: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
		...
		case 69: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 70: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 71: return (GameObject)Instantiate (whiteJewel, position, Quaternion.identity);
			
		case 72: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 73: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (blueJewel, position, Quaternion.identity);
		case 75: return (GameObject)Instantiate (redJewel, position, Quaternion.identity);
		case 76: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 77: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		case 78: return (GameObject)Instantiate (orangeJewel, position, Quaternion.identity);
		case 79: return (GameObject)Instantiate (greenJewel, position, Quaternion.identity);
		case 80: return (GameObject)Instantiate (purpleJewel, position, Quaternion.identity);
		}
		return null;
	}
