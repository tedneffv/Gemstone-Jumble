...
public class CabinLevelTwentyThreeCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 1: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 2: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 3: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 4: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 5: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 6: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 7: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 8: return GetBlockBomb (position, bombNumber90, boulderStage3);
			
		case 9: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 10: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 11: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 15: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 16: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 17: return GetBlockBomb (position, bombNumber90, boulderStage3);
			
		case 18: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 19: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 25: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 26: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 27: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 35: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 45: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 53: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 54: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 55: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 61: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 62: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
			
		case 63: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 64: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 65: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 69: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 70: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 71: return GetBlockBomb (position, bombNumber90, boulderStage3);
			
		case 72: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 73: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 74: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 75: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 76: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 77: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 78: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 79: return GetBlockBomb (position, bombNumber90, boulderStage3);
		case 80: return GetBlockBomb (position, bombNumber90, boulderStage3);
		}
		return null;
	}
