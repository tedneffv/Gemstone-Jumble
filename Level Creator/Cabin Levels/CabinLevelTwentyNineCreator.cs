...
public class CabinLevelTwentyNineCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 20: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 21: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 22: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 23: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 24: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 29: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 30: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 31: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 32: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 33: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 38: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 39: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 40: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 41: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 42: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 47: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 48: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 49: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 50: return GetBlockBomb (position, bombNumber40, boulderStage3);
		case 51: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 56: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 57: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 58: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 59: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 60: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
