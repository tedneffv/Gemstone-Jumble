...
public class CabinLevelElevenCreator : MonoBehaviour {
	...
	GameObject GetSlugBomb (Vector3 position, GameObject bombNumber) {
		...
		tempSlug = (GameObject)Instantiate (slugStage1, new Vector3 (position.x, position.y, -.5f), Quaternion.identity); 
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber20);
		...
		case 4: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 8: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 18: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 26: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 36: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 54: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 62: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 72: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 76: temp = GetSlugBomb (position, bombNumber20);
				SlugListManager.AddToSlugList (temp);
				return temp;
		...
		case 80: temp = GetSlugBomb (position, bombNumber20);
			SlugListManager.AddToSlugList (temp);
			return temp;
		}
		return null;
