...
public class CabinLevelFourCreator : MonoBehaviour {
	...
	public GameObject boulder, boulderStage2, boulderStage3, steelBlock, pauseButton, topBanner, bottomBanner, powerButton, glassBorder, slug, slugStage2, slugStage3;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
		...
		case 9: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 17: return GetBomb (position, bombNumber10);
			
		case 18: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 26: return GetBomb (position, bombNumber10);
			
		case 27: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 35: return GetBomb (position, bombNumber10);
			
		case 36: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: return GetBomb (position, bombNumber10);
			
		case 45: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 53: return GetBomb (position, bombNumber10);
			
		case 54: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 62: return GetBomb (position, bombNumber10);
			
		case 63: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 71: return GetBomb (position, bombNumber10);
			
		case 72: temp = (GameObject)Instantiate (slugStage2, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
