...
public class CabinLevelTwentyEightCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBlockBomb (position, bombNumber90, boulder);
		...
		case 8: return GetBlockBomb (position, bombNumber90, boulder);
			
		case 9: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		case 10: return GetBlockBomb (position, bombNumber90, boulder);
		...
		case 16: return GetBlockBomb (position, bombNumber90, boulder);
		...
		case 20: return GetBlockBomb (position, bombNumber90, boulder);
		...
		case 24: return GetBlockBomb (position, bombNumber90, boulder);
		...
		case 30: return GetBlockBomb (position, bombNumber90, boulderStage2);
		case 31: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 32: return GetBlockBomb (position, bombNumber90, boulderStage2);
		...
		case 40: return GetBlockBomb (position, bombNumber90, boulderStage2);
		...
		case 48: return GetBlockBomb (position, bombNumber90, boulderStage2);
		case 49: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 50: return GetBlockBomb (position, bombNumber90, boulderStage2);
		...
		case 56: return GetBlockBomb (position, bombNumber90, boulderStage3);
		...
		case 60: return GetBlockBomb (position, bombNumber90, boulderStage3);
		...
		case 64: return GetBlockBomb (position, bombNumber90, boulderStage3);
		...
		case 70: return GetBlockBomb (position, bombNumber90, boulderStage3);
