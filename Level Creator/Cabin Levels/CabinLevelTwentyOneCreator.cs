...
public class CabinLevelTwentyOneCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber60);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 3: return GetBlockBomb (position, bombNumber60, boulderStage2);
		case 4: return GetBlockBomb (position, bombNumber60, boulderStage2);
		case 5: return GetBlockBomb (position, bombNumber60, boulderStage2);
		...
		case 66: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 67: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 68: temp = (GameObject)Instantiate (slugStage2, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 75: return GetBlockBomb (position, bombNumber60, boulderStage2);
		case 76: return GetBlockBomb (position, bombNumber60, boulderStage2);
		case 77: return GetBlockBomb (position, bombNumber60, boulderStage2);
