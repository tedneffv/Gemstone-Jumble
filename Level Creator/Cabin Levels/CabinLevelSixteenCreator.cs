...
public class CabinLevelSixteenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 38: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 42: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 56: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 57: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 58: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 59: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 60: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
