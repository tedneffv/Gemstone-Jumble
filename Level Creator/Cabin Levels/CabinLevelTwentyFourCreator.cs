...
public class CabinLevelTwentyFourCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber15, bombNumber45, bombNumber75;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 75: return GetBomb (position, bombNumber75);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 20: return GetBlockBomb (position, bombNumber15, boulder);
		...
		case 30: return GetBlockBomb (position, bombNumber15, boulder);
		...
		case 40: return GetBlockBomb (position, bombNumber45, boulderStage2);
		...
		case 50: return GetBlockBomb (position, bombNumber45, boulderStage2);
		...
		case 60: return GetBlockBomb (position, bombNumber45, boulderStage2);
		...
		case 70: return GetBlockBomb (position, bombNumber75, boulderStage3);
		...
		case 80: return GetBlockBomb (position, bombNumber75, boulderStage3);
		}
		return null;
	}
