...
public class CabinLevelSevenCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 30: return GetBomb (position, bombNumber40);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 4: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 10: return GetBomb (position, bombNumber40);
		...
		case 13: return GetBomb (position, bombNumber40);
		...
		case 40: return GetBomb (position, bombNumber40);
		...
		case 67: return GetBomb (position, bombNumber40);
		...
		case 70: return GetBomb (position, bombNumber40);
		...
		case 76: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 80: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		}
		return null;
	}
