...
public class CabinLevelFiveCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 30: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 31: return GetBomb (position, bombNumber20);
		case 32: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 48: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 49: return GetBomb (position, bombNumber20);
		case 50: temp = (GameObject)Instantiate (slugStage3, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
