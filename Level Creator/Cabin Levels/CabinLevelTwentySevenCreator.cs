...
public class CabinLevelTwentySevenCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber95;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber95);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBlockBomb (position, bombNumber95, boulderStage3);
		case 1: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 3: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 4: return GetBlockBomb (position, bombNumber95, boulderStage3);
		case 5: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 6: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 8: return GetBlockBomb (position, bombNumber95, boulderStage3);
			
		case 9: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 10: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 11: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 12: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 13: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 14: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 15: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 16: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 17: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 27: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 28: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 29: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 30: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 31: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 32: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 33: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 34: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 35: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
			
		case 36: return GetBlockBomb (position, bombNumber95, boulderStage3);
		case 37: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 38: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 39: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 40: return GetBlockBomb (position, bombNumber95, boulderStage3);
		case 41: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 42: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 43: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 44: return GetBlockBomb (position, bombNumber95, boulderStage3);
			
		case 45: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity); 
		case 46: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 47: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 48: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 49: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 50: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 51: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 52: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 53: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 63: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 64: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 65: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 66: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 67: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 68: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 69: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 70: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 71: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
			
		case 72: return GetBlockBomb (position, bombNumber95, boulderStage3);
		case 73: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 75: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 76: return GetBlockBomb (position, bombNumber95, boulderStage3);
		case 77: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 78: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 79: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 80: return GetBlockBomb (position, bombNumber95, boulderStage3);
		}
		return null;
	}
