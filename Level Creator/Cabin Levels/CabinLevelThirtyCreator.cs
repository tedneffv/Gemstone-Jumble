...
public class CabinLevelThirtyCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 18: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 26: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 36: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 54: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 62: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
