...
public class CabinLevelThirteenCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 17: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 35: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 53: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 71: temp = GetSlugBomb (position, bombNumber40, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
