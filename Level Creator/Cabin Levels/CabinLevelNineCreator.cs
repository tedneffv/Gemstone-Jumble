...
public class CabinLevelNineCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber60);
		case 1: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 2: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 6: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 7: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 8: return GetBomb (position, bombNumber60);
			
		case 9: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 10: return GetBomb (position, bombNumber60);
		case 11: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 15: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 16: return GetBomb (position, bombNumber60);
		case 17: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
			
		case 18: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 19: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 20: return GetBomb (position, bombNumber60);
		case 21: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 22: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 23: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 24: return GetBomb (position, bombNumber60);
		case 25: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 26: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 29: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 30: return GetBomb (position, bombNumber60);
		case 31: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 32: return GetBomb (position, bombNumber60);
		case 33: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 40: return GetBomb (position, bombNumber60);
		...
		case 47: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 48: return GetBomb (position, bombNumber60);
		case 49: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 50: return GetBomb (position, bombNumber60);
		case 51: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 54: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 55: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 56: return GetBomb (position, bombNumber60);
		case 57: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 58: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 59: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 60: return GetBomb (position, bombNumber60);
		case 61: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 62: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
			
		case 63: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 64: return GetBomb (position, bombNumber60);
		case 65: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 69: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 70: return GetBomb (position, bombNumber60);
		case 71: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
			
		case 72: return GetBomb (position, bombNumber60);
		case 73: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 74: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 78: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 79: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 80: return GetBomb (position, bombNumber60);
		}
		return null;
	}
