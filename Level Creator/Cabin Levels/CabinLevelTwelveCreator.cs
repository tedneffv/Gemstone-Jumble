...
public class CabinLevelTwelveCreator : MonoBehaviour {
	...
	public GameObject boulder, boulderStage2, boulderStage3, steelBlock, pauseButton, topBanner, bottomBanner, powerButton, glassBorder, slugStage1;
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber20, slugStage1);
		...
		case 4: temp = GetSlugBomb (position, bombNumber20, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 8: temp = GetSlugBomb (position, bombNumber20, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 74: temp = GetSlugBomb (position, bombNumber20, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 78: temp = GetSlugBomb (position, bombNumber20, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
