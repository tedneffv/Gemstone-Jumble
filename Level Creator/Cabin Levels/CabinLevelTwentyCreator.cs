...
public class CabinLevelTwentyCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 45: return GetBomb (position, bombNumber65);
		}
		return null;
	}
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 20: return GetBlockBomb (position, bombNumber65, boulder);
		case 21: return GetBlockBomb (position, bombNumber65, boulder);
		case 22: return GetBlockBomb (position, bombNumber65, boulder);
		case 23: return GetBlockBomb (position, bombNumber65, boulder);
		case 24: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 29: return GetBlockBomb (position, bombNumber65, boulder);
		case 30: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 31: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 32: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 33: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 38: return GetBlockBomb (position, bombNumber65, boulder);
		case 39: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 40: return GetBlockBomb (position, bombNumber65, boulderStage3);
		case 41: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 42: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 47: return GetBlockBomb (position, bombNumber65, boulder);
		case 48: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 49: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 50: return GetBlockBomb (position, bombNumber65, boulderStage2);
		case 51: return GetBlockBomb (position, bombNumber65, boulder);
		...
		case 56: return GetBlockBomb (position, bombNumber65, boulder);
		case 57: return GetBlockBomb (position, bombNumber65, boulder);
		case 58: return GetBlockBomb (position, bombNumber65, boulder);
		case 59: return GetBlockBomb (position, bombNumber65, boulder);
		case 60: return GetBlockBomb (position, bombNumber65, boulder);
