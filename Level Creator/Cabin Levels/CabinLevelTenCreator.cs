...
public class CabinLevelTenCreator : MonoBehaviour {
	...
	GameObject GetSlugBomb (Vector3 position, GameObject bombNumber) {
		GameObject tempSlug = null, tempNumber;
		tempSlug = (GameObject)Instantiate (slugStage1, position, Quaternion.identity); 
		tempNumber = (GameObject)Instantiate (bombNumber, new Vector3 (tempSlug.transform.position.x, tempSlug.transform.position.y -.1f, tempSlug.transform.position.z - .1f), Quaternion.identity);
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: return GetBomb (position, bombNumber50);
		case 1: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
		...
		case 7: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 8: return GetBomb (position, bombNumber50);
			
		case 9: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 17: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 63: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 71: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 72: return GetBomb (position, bombNumber50);
		case 73: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 79: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 80: return GetBomb (position, bombNumber50);
		}
		return null;
	}
