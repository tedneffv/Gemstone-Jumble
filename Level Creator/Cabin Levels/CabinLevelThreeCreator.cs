...
public class CabinLevelThreeCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 2: temp = (GameObject)Instantiate (slugStage3, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 3: return GetBomb (position, bombNumber20);
		case 4: return GetBomb (position, bombNumber20);
		case 5: return GetBomb (position, bombNumber20);
		case 6: temp = (GameObject)Instantiate (slugStage3, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 12: temp = (GameObject)Instantiate (slugStage3, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 13: return GetBomb (position, bombNumber20);
		case 14: temp = (GameObject)Instantiate (slugStage3, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 22: temp = (GameObject)Instantiate (slugStage3, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
