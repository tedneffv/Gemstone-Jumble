...
public class CabinLevelTwentySixCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber43;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 100: return GetBomb (position, bombNumber43);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 1: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 2: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 3: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 4: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 5: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 6: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 7: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 8: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 9: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 17: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 18: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 26: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 27: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 35: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 36: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 44: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 45: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 53: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 54: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 62: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 63: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 71: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 72: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 73: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 74: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 75: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 76: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 77: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 78: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 79: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 80: temp = GetSlugBomb (position, bombNumber43, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		}
		return null;
