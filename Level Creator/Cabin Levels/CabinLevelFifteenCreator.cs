...
public class CabinLevelFifteenCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 60: return GetBomb (position, bombNumber50);
		}
		return null;
	}
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		GameObject temp;
		switch (jewelNumber) {
		case 0: temp = GetSlugBomb (position, bombNumber50, slugStage1);
		...
		case 8: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 11: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 15: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 19: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 25: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 39: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 40: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 41: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 55: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 61: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 65: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 69: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 72: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 80: temp = GetSlugBomb (position, bombNumber50, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		}
		return null;
