...
public class CabinLevelSeventeenCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 35: return GetBomb (position, bombNumber30);
		}
		return null;
	}
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 12: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 13: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 14: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity); 
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 18: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 22: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 26: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
			
		case 27: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 28: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 34: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 35: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);

		case 36: return GetBomb (position, bombNumber30);
		case 37: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 38: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 42:temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 43: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 44: return GetBomb (position, bombNumber30);
			
		case 45: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 46: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 52: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 53: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
			
		case 54: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 58: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 62: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 66: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 67: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 68: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 74: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 75: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 76: return GetBomb (position, bombNumber30);
		case 77: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 78: temp = (GameObject)Instantiate (slugStage1, position, Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
