...
public class CabinLevelTwentyFiveCreator : MonoBehaviour {
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 10: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 11: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 12: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 13: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 14: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 15: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 16: return GetBlockBomb (position, bombNumber55, boulderStage3);
		...
		case 28: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 29: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 30: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 31: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 32: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 33: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 34: return GetBlockBomb (position, bombNumber55, boulderStage3);
		...
		case 46: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 47: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 48: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 49: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 50: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 51: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 52: return GetBlockBomb (position, bombNumber55, boulderStage3);
		...
		case 64: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 65: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 66: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 67: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 68: return GetBlockBomb (position, bombNumber55, boulderStage3);
		case 69: return (GameObject)Instantiate (GetRandomJewel (), position, Quaternion.identity);
		case 70: return GetBlockBomb (position, bombNumber55 , boulderStage3);
