...
public class CabinLevelEighteenCreator : MonoBehaviour {
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 50: return GetBomb (position, bombNumber65);
		}
		return null;
	}
...
//		}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 11: temp = GetSlugBomb (position, bombNumber65, slugStage1);
		...
		case 19: temp = GetSlugBomb (position, bombNumber65, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 20: return (GameObject)Instantiate (boulder, position, Quaternion.identity);
		case 21: temp = GetSlugBomb (position, bombNumber65, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 29: temp = GetSlugBomb (position, bombNumber65, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 33: temp = GetSlugBomb (position, bombNumber65, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 41: temp = GetSlugBomb (position, bombNumber65, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 42: return (GameObject)Instantiate (boulderStage2, position, Quaternion.identity);
		case 43: temp = GetSlugBomb (position, bombNumber65, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 48: temp = GetSlugBomb (position, bombNumber65, slugStage3);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 51: temp = GetSlugBomb (position, bombNumber65, slugStage2);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 56: temp = GetSlugBomb (position, bombNumber65, slugStage3);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 57: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 58: temp = GetSlugBomb (position, bombNumber65, slugStage3);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 66: temp = GetSlugBomb (position, bombNumber65, slugStage3);
			SlugListManager.AddToSlugList (temp);
			return temp;
