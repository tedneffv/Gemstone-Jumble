...
public class CabinLevelFourteenCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 30: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 31: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 32: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		...
		case 40: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		...
		case 48: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 49: return (GameObject)Instantiate (boulderStage3, position, Quaternion.identity);
		case 50: temp = GetSlugBomb (position, bombNumber30, slugStage1);
			SlugListManager.AddToSlugList (temp);
			return temp;
