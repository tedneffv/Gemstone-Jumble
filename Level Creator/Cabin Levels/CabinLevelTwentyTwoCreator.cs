...
public class CabinLevelTwentyTwoCreator : MonoBehaviour {
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 31: return GetBlockBomb (position, bombNumber35, boulderStage3);
		...
		case 39: return GetBlockBomb (position, bombNumber35, boulderStage3);
		case 40: return GetBlockBomb (position, bombNumber35, boulderStage3);
		case 41: return GetBlockBomb (position, bombNumber35, boulderStage3);
		...
		case 49: return GetBlockBomb (position, bombNumber35, boulderStage3);
