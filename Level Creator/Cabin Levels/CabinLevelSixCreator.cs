...
public class CabinLevelSixCreator : MonoBehaviour {

	public GameObject blueJewel, greenJewel, orangeJewel, purpleJewel, redJewel, whiteJewel;
	public GameObject blueBomb, greenBomb, orangeBomb, purpleBomb, redBomb, whiteBomb, bombNumber75;
	public GameObject boulder, boulderStage2, boulderStage3, steelBlock, pauseButton, topBanner, bottomBanner, powerButton, glassBorder, slug;
	...
	GameObject GetCorrectBomb (int bombNumber, Vector3 position) {
		switch (bombNumber) {
		case 60: return GetBomb (position, bombNumber75);
		}
		return null;
	}
	...
	GameObject GetJewels (int jewelNumber, Vector3 position) {
		...
		case 36: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 37: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 38: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 39: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 40: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 41: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 42: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 43: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
		case 44: temp = (GameObject)Instantiate (slug, new Vector3 (position.x, position.y, -.5f), Quaternion.identity);
			SlugListManager.AddToSlugList (temp);
			return temp;
